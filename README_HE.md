# Eden Zino — פלטפורמת סדנאות גרסה 1.8.1

> **v1.8.0:** מדיה שהועלתה ל-R2 נשמרת לפי `object_key` ומוגשת ב-URL יחסי. נוספו נתוני נגישות לכל סדנה, הצהרת נגישות, פרטי קשר נגישות ו-R2 Integrity Check. ראו `docs/UPGRADE_1_8_HE.md`.

> **v1.8.1:** בכל מקום שבו בוחרים תמונה ניתן גם לפתוח ספריית מדיה, לחפש תמונה שכבר הועלתה ולבחור בה ללא העלאה כפולה. ראו `docs/MEDIA_LIBRARY_1_8_1_HE.md`.
...
- Resend לדוא״ל ו־Webhooks חתומים לחשבוניות. WhatsApp כבוי כברירת מחדל עד לחיבור חשבון עסקי פעיל.
